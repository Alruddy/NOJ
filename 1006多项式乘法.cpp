...
void Polynome::PolyMul(Polynome &r)
{
    Term *p=thisList->link;
    Term *q=r.thisList->link;
    Polynome temp1(*this);
    while(p)
    {
        thisList->link=p->link;
        delete p;
        p=thisList->link;
    }
    while(q)
